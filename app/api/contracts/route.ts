...
async function searchPostgres(queryEmbedding: number[], tableName: string = 'contracts', topK: number = 5): Promise<SearchResult[]> {
...
export async function POST(req: Request) {
  ...
  try {
    ...
    try {
      ...
      const searchResults = await searchPostgres(queryEmbedding, 'contracts');
