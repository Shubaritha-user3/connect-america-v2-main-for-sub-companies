...
2. Related to the following artificial intelligence topics:
    - Machine Learning and algorithms
    - Deep Learning and neural networks
    - Natural Language Processing
    - AI Ethics and responsible AI
    - AI implementation and applications
...
3. Related to:
    ...
    - AI performance measurement and metrics
    - AI infrastructure and computing requirements
    - Machine learning frameworks and libraries
4. A follow-up question to the previous conversation about these AI topics
5. Related to violence, harmful activities, or other inappropriate content
6. Completely unrelated to artificial intelligence and machine learning topics

Respond with only one of these categories:
GREETING - for category 1
RELEVANT - for categories 2, 3, or 4
...
async function searchPostgres(queryEmbedding: number[], tableName: string = 'lifeline', topK: number = 5): Promise<SearchResult[]> {
...
export async function POST(req: Request) {
  ...
  try {
    ...
    try {
      ...
      const searchResults = await searchPostgres(queryEmbedding, 'lifeline');
